...
function Paciente({paciente, setPaciente, eliminarPaciente}) {
  const {nombre, propietario, email, fechas, sintomas, id} = paciente
  ...
  return (
    <div className="m-3 bg-white shadow-sm px-5 py-10 rounded-xl">
        ...
        <p className="font-bold mb-3 text-gray-700  uppercase">Proietario: {''}
        ...
        <p className="font-bold mb-3 text-gray-700  uppercase">Fecha alta : {''}
          <span className="font-normal normal-case">{fechas}</span>
        </p>
